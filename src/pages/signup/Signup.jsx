    ...
    <div className={styles.login_container}>
      ...
      <div className={styles.login_left_container}>
        <div className={styles.login_left}>
          <h1 className={styles.login_heading}>ثبت نام</h1>
          <div>
            <span className={styles.login_text1}>حساب کاربری دارید؟</span>
            <a className={styles.login_link}> از اینجا وارد شوید</a>
          </div>
          <div className={styles.login_input_box}>
            <label className={styles.login_label}>نام و نام خانوادگی</label>
            <input type="text" className={styles.login_input} value={email} />
          </div>
          <div className={styles.login_input_box}>
          ...
          <button className={styles.login_log_btn}>ثبت نام</button>
